...
export const ModelProvider: ModelProviderType = {
    ...
    AZURE: { id: 5, name: 'Azure', apiKey: 'AZURE_API_KEY' }
}
...
export const Model: ModelType = {
    ...
    GPT_4_O_MINI_VERSION_2024_07_18: { id: 8, name: "gpt-4o-mini (version:2024-07-18)", provider: ModelProvider.AZURE },
    GPT_4_O_MINI: { id: 9, name: "gpt-4o-mini", provider: ModelProvider.AZURE }
}
...
export const ModelArray: ModelValeuType[] = [
    ...
    { id: 6, name: 'llama-3.1-70b-versatile', provider: ModelProvider.GROQ },
    { id: 7, name: 'gpt-4o-2024-11-20', provider: ModelProvider.OPENAI },
    { id: 8, name: "gpt-4o-mini (version:2024-07-18)", provider: ModelProvider.AZURE },
    { id: 9, name: "gpt-4o-mini", provider: ModelProvider.AZURE }
]
